...
func ExampleLog() {
	...
	LogAccess(nil, EgressTraffic, start, time.Millisecond*1500, "test-route", req, resp)

	//Output:
	//{"traffic":"egress","start-time":"2025-07-17T12:27:10.000Z","duration-ms":1500,"route":"test-route","method":"PUT","url":"https://www.google.com/search?q=golang","status-code":418,"encoding":"gzip","bytes-received":12345,"timeout-ms":456}
